...
export function App1() {
  ...
  return (
    <div>
      ...
      {/* <MovieCard mov = {data[0]} />
      <MovieCard mov = {data[1]} />
      <MovieCard mov = {data[2]} />
      <MovieCard mov = {data[3]} />
      <MovieCard mov = {data[4]} />
      <MovieCard mov = {data[5]} />
      <MovieCard mov = {data[6]} />
      <MovieCard mov = {data[7]} />
      <MovieCard mov = {data[8]} />
      <MovieCard mov = {data[9]} /> */}
...
/*
  ...
  let datum = {
    Heading: "Iron Man",
    Date: "2008",
    Post: "https://m.media-amazon.com/images/M/MV5BMTczNTI2ODUwOF5BMl5BanBnXkFtZTcwMTU0NTIzMw@@._V1_SX300.jpg"
  }
  return (
    <div>
      <h1 className="header">Lorem ipsum doler sit amet.</h1>
      <MovieCard moni={datum}/>
    </div>
  );
}
*/
